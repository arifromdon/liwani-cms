    ...
    return (
      <div className="pagination-component">
        <ul>
          {pages}
          {/* <li>
            <span><img src="/assets/icon-double-left.svg" alt="icon-double-left" /></span>
          </li>
          <li>
            <span><img src="/assets/icon-one-left.svg" alt="icon-double-left" /></span>
          </li>
          <li>
            <span>1</span>
          </li>
          ...
          <li>
            <span><img src="/assets/icon-one-right.svg" alt="icon-double-left" /></span>
          </li>
           <li>
            <span><img src="/assets/icon-double-right.svg" alt="icon-double-left" /></span>
          </li> */}
        </ul>
      </div>
    )
